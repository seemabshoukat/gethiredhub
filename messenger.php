                        ...
                        <div class="mt-5" style="padding: 15px 20px;box-shadow: 0 0 27px 0 rgba(48,48,48,.09);">
                            ...
                            <div class="row">
                                <div class="col-md-3" style="height: 500px;overflow-y: scroll;">
                                    <?php
                                        ...
                                        $current_user_id = $_SESSION['js_id'];

                                        $messages = mysqli_query($connection, "SELECT * FROM messages WHERE js_id = '$current_user_id' GROUP BY company_id");
                                        $countMessages = mysqli_num_rows($messages);

                                        while ($sender = mysqli_fetch_array($messages)) {

                                            $company = mysqli_fetch_array(mysqli_query($connection, "SELECT * FROM companies WHERE company_id = '" . $sender['company_id'] . "'"));

                                            ?>

                                            <a href="messenger.php?company_id=<?php echo $company['company_id']; ?>">
                                               <div class="row pt-3 pb-3" style="border-right: 1px solid #efefef;border-bottom: 1px solid #efefef;">
                                               
                                                  <div class="col-md-4"><img src="img/company_logos/<?php echo $company['logo']; ?>" style="width: 100px;border-radius: 50%;height: 50px;width: 50px;"></div>
                                                  <div class="col-md-8">
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-9 messengerBubbles">
                                    ...
                                    <div class="d-flex">
                                        <input id="reciever" type="hidden" name="company_id" value="<?php if(isset($_GET['company_id'])) { echo $_GET['company_id']; } ?>">
                                        <input id="sender" type="hidden" name="js_id" value="<?php echo $_SESSION['js_id']; ?>">
...
<script>
    ...
    function Get_chat() {
        ...
        $.ajax({
            ...
            url: 'includes/requests/fetch_seeker_chat.php',
            type: 'GET',
    ...
    $("#btn_messenger").click(function(){
        ...
        $.ajax({
            ...
            url: "includes/requests/send_seeker_message.php",
            type: "POST",
            data: {
                reciever:reciever,
                sender:sender,
